...
import { ShieldCheck, FileText, Users, FileJson, ArrowRight, Search, X, FileCheck } from 'lucide-react';
...
const modulos = [
  ...
  {
    title: 'CENPROT', // Novo módulo
    desc: 'Validação de Apontamento, Protesto e Cancelamento',
    path: '/auditoria/cenprot',
    icon: FileCheck,
    color: 'text-green-500',
    bg: 'bg-green-50 dark:bg-green-900/20',
    tags: ['cenprot', 'apontamento', 'protesto', 'cancelamento']
  },
  {
    title: 'RCTO',
  ...
  {
    title: 'CRC',
    desc: 'Validador de Carga CRC (XML)',
    path: '/auditoria/crc',
    icon: FileCheck,
    color: 'text-teal-500',
    bg: 'bg-teal-50 dark:bg-teal-900/20',
    tags: ['crc', 'xml', 'xsd', 'validacao']
  }
];
