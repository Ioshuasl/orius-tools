...
const MODULOS_INFO: Record<string, any> = {
  ...
  '/auditoria/cenprot': { title: 'CENPROT', icon: FileCheck, color: 'text-green-500', bg: 'bg-green-50 dark:bg-green-900/20' },
  '/auditoria/crc': { title: 'CRC', icon: FileCode, color: 'text-red-500', bg: 'bg-red-50 dark:bg-red-900/20' },
  ...
  '/cbo': { title: 'CBO', icon: Briefcase, color: 'text-yellow-500', bg: 'bg-yellow-50 dark:bg-yellow-900/20' },
  '/ibge-municipios': { title: 'IBGE Municípios', icon: MapPin, color: 'text-cyan-500', bg: 'bg-cyan-50 dark:bg-cyan-900/20' },
};
...
export default function Home() {
  ...
  const atalhosRapidos = [
    ...
    { label: 'CENPROT', path: '/auditoria/cenprot', icon: FileCheck, color: 'text-green-600', bg: 'bg-green-50 dark:bg-green-500/10' },
    { label: 'CRC', path: '/auditoria/crc', icon: FileCode, color: 'text-red-600', bg: 'bg-red-50 dark:bg-red-500/10' },
    ...
    { label: 'Profissões (CBO)', path: '/cbo', icon: Briefcase, color: 'text-yellow-600', bg: 'bg-yellow-50 dark:bg-yellow-500/10' },
    { label: 'IBGE Municípios', path: '/ibge-municipios', icon: MapPin, color: 'text-cyan-600', bg: 'bg-cyan-50 dark:bg-cyan-500/10' },
  ];
